      ...
      <ul class="space-y-2 font-medium mt-7">
         <li class="px-3">
            <a href="{{ url('dashboard') }}" class="flex items-center p-2  rounded-lg  hover:bg-gray-100  group ml-0.5 mt-2">
               <img src="gambar/gridred.svg" alt="">
               <span class="ms-3 text-red-600">Dashboard</span>
            </a>
         </li>
...
<div class="p-4 md:ml-64">
   <div class="p-4  border-gray-200 rounded-lg ">
      ...
      <div>
         <p class="text-2xl font-semibold ml-24 md:ml-[76px]">Pendapatan</p>
         <div class="justify-between grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 px-6 md:px-12 lg:px-16">
            <div class="mb-4">
               <a href="" class="justify-between bg-[#069945] flex p-3 w-72 py-6 mt-2">
               <div>
                  <p class="text-xl font-semibold text-white">Rp. 2.222.222,00</p>
                  <p class="text-xl font-semibold text-white pt-2">Bulan Ini</p>
               </div>
               <img src="gambar/bar-chart.png" alt="">
               </a>
            </div>
            <div class=" mb-4">
               <a href="" class="justify-between bg-[#E8312D] flex p-3 w-72 py-6 mt-2">
               <div>
                  <p class="text-xl font-semibold text-white">Rp. 2.222.222,00</p>
                  <p class="text-xl font-semibold text-white pt-2">Minggu Ini</p>
               </div>
               <img src="gambar/bar-chart.png" alt="">
               </a>
            </div>
            <div class=" mb-4">
               <a href="" class="justify-between bg-[#442A73] flex p-3 w-72 py-6 mt-2">
               <div>
                  <p class="text-xl font-semibold text-white">Rp. 2.222.222,00</p>
                  <p class="text-xl font-semibold text-white pt-2">Hari Ini</p>
               </div>
               <img src="gambar/bar-chart.png" alt="">
               </a>
            </div>
