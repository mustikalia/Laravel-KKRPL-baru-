...
<div class="p-0 md:ml-64">
   <div class="p-0  border-gray-200 rounded-lg ">
      <div class="flex justify-center mb-4 ">
         ...
         <div class="flex flex-col md:flex-row ml-12 mt-1">
            ...
            <div class="w-[120px] ml-2 shadow-xl hidden" id="isi">
               <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Hari Ini</a>
               <hr class="bg-gray-600 h-0.5">
               <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Minggu ini</a>
               <hr class="bg-gray-600 h-0.5">
               <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Bulan Ini</a>
               <hr class="bg-gray-600 h-0.5">
            </div>
         </div>
      </div>
      ...
      <hr class="bg-gray-600 h-0.5">
      <div class="flex flex-col px-2 mt-3 mb-4">
         <div class="flex flex-row">
            <img src="gambar/geo-alt-fill.svg" alt="">
            <p class="text-2xl font-bold ml-2">Keterangan Pembeli</p>
         </div>
