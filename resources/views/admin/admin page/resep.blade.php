      ...
      <ul class="space-y-2 font-medium mt-7">
         ...
         <li class="px-3">
            <a href="{{ url('resep') }}" class="flex items-center p-2 text-gray-900 rounded-lg -ml-0.5 hover:bg-gray-100 group mt-2">
               ...
               <span class="ms-3 text-red-600">Resep</span>
            </a>
         </li>
         <hr class="bg-gray-600 h-0.5">
         <li class="px-3">
...
<div class="p-0 md:ml-64">
   <div class="p-0  border-gray-200 rounded-lg ">
      ...
      <p class="font-bold text-3xl ml-6 xl:ml-8">Resep</p>
      <div class="mt-4">
         <hr class="bg-gray-600 h-0.5">
         <div href="" class="flex p-4">
            <img src="gambar/Ellipse 115.png" alt="">
            <div class="justify-between flex w-full">
               <div class="flex flex-col">
                  <p class="font-bold text-xl ml-3 mt-2">Pelanggan 1 </p>
                  <div class="flex flex-row ml-2 mt-2">
                     <img src="gambar/filetype-jpg.svg" alt="">
                     <a href="" class="text-lg font-semibold underline">IMG111.JPG</a>
                  </div>               
               </div>
               <a href="" class="my-auto">
                  <img src="gambar/message.svg" alt="" class="w-12">
               </a>
            </div>
         </div>
         <hr class="bg-gray-600 h-0.5">
