   ...
   <div class="p-0  border-gray-200 rounded-lg ">
      <div class="flex mb-4 ">
         <div class="flex mt-2">
            ...
            <span class="font-bold text-xl text-red-600 ml-2">Edit <span class="text-2xl text-black"><br>Produk</span></span>
         </div>    
      </div>
      <div class="px-6">
         <div class="mb-4">
            <p class="text-xl font-semibold ml-0.5">Foto Produk</p>
            {{-- <div class="bg-[#DCDCDC] p-4 rounded-xl w-[70%]"><span class="font-black">+</span> Pilih Foto Produk</div>  --}}
         ...
         <div class="mb-4">
            <p class="text-xl font-semibold ml-0.5">Nama Produk</p>
            <input class="bg-[#DCDCDC] p-4 rounded-xl w-[70%] text-black placeholder-black" placeholder="Isi Nama Produk"></input> 
          </div>
          <div>
            <p class="text-xl font-semibold ml-0.5">Harga Produk</p>
            <input class="bg-[#DCDCDC] p-4 rounded-xl w-[70%] placeholder-black" placeholder="Isi Harga Produk"></input> 
         </div>
         <a href="" class="bg-red-600 px-6 py-4 text-white text-xl font-semibold shadow-xl rounded-3xl flex w-36 justify-center mt-4">Simpan</a>
      </div>
