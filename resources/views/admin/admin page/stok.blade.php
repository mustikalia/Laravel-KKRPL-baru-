      ...
      <div>
         <div class="flex justify-between px-4 mt-5">
            <div class="flex flex-row ">
               <button href="" class="justify-between flex bg-red-600 p-3 h-12 px-4  gap-4">
                  <p class="text-white font-medium text-md" id="buka">Kategori</p>
                  <img src="gambar/Polygon 1.svg" alt="" class="w-3 mt-1" id="tutup">
               </button>
               <div class="w-[120px] ml-2 shadow-xl hidden" id="isi">
                  <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Obat-Obatan</a>
                  <hr class="bg-gray-600 h-0.5">
                  <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Kosmetik</a>
                  <hr class="bg-gray-600 h-0.5">
                  <a href="" class="px-4 py-0.5 font-semibold text-sm text-center">Ibu & Anak</a>
                  <hr class="bg-gray-600 h-0.5">
               </div>
            </div>
            <a href="" class="flex bg-white border border-red-600 p-3 px-4 rounded-xl py-1 md:py-4 h-12 md:h-14 shadow-xl ">
               <p class="text-red-600 font-medium text-md">Tambahkan produk</p>
            </a>
         </div>
         <div class="mt-4">
            <hr class="bg-gray-600 h-0.5">
            
            <div class="justify-between flex px-10 md:px-20 py-6">
               <div class="flex">
                  <p class="my-auto text-2xl font-semibold pr-1 md:pr-7">1</p>
                  <img src="gambar/Rectangle 4236.png" alt="" class="w-24">
                  <div class="pl-3 my-auto">
                     <p>Paramex (Obat sakit kepala) </p><span>Rp. 10.000</span>
                  </div>
                  
               </div>
               <div class="my-auto">
                  <a href="{{ url('stok1') }}" class="mr-5 text-xl font-semibold text-[#442A73]">Edit</a>
                  <a href="Delete" class="text-xl font-semibold text-red-600">Delete</a>
               </div>
            </div>
            <div class="flex pb-4 ml-[120px]">
               <img src="gambar/info-circle-fill.svg" alt="" >
               <a href="{{ url('stok2') }}" class="text-lg text-red-600 pl-3">Edit Deskripsi Produk</a>
            </div>
...
<script>
   ...
   const bukaIsiBtn = document.getElementById('buka');
   const tutupIsiBtn = document.getElementById('tutup');
   const isi = document.getElementById('isi');

   bukaIsiBtn.addEventListener('click', () => {
   isi.classList.remove('hidden');
   });

   tutupIsiBtn.addEventListener('click', () => {
