   ...
   <div class="h-full px-0 pt-4 py-2 md:py-4 overflow-y-auto bg-white  border-r-2">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li class="px-3">
            ...
            <a href="{{ url('main2') }}" class="flex items-center p-2 text-red-600 rounded-lg  hover:bg-gray-100  group mt-2">
         ...
         <li class="px-3">
            <a href="{{ url('main4') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
               <img src="gambar/Vectorred.svg" alt="">
               <span class="ms-3 text-red-600">Kosmetik</span>
            </a>
         </li>
         <hr class="bg-gray-600 h-0.5">
         <li class="px-3">
...
<div class="p-4 md:ml-64">
   <div class="p-4  border-gray-200 rounded-lg ">
      ...
      <p class="font-bold text-2xl ml-10 xl:ml-16">KOSMETIK</p>
