...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-0 pt-4 py-2 md:py-4 overflow-y-auto bg-white  border-r-2">
      <a href="https://smktelkom-mks.sch.id" class="flex items-center ps-2.5 mb-5">
         ...
         <span class="self-center text-lg font-semibold text-red-600" id="utama" id="utama">Apotik <span class="text-blue-600"><br>Hinda Farma</span></span>
      </a>
      <ul class="space-y-2 font-medium">
         <li class="px-3">
            <a href="{{ url('main') }}" class="flex items-center p-2 text-red-600 rounded-lg  hover:bg-gray-100  group">
               <img src="gambar/Homered.svg" alt="" class="">
...
<div class="p-4 md:ml-64">
   <div class="p-4  border-gray-200 rounded-lg ">
      ...
      <p class="font-bold text-2xl ml-10 xl:ml-16">Produk Terlaris</p>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-2 justify-center gap-1 ">
