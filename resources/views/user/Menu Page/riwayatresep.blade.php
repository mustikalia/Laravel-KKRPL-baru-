   ...
   <div class="p-0  border-gray-200 rounded-lg ">
      <div class="flex mb-4 ">
         <div class="flex mt-2">
            ...
            <span class="text-2xl text-black font-bold my-auto ml-3">Riwayat Kirim Resep</span>
         </div>    
      </div>
      <div class="container">
         <p class="text-3xl font-extrabold px-6 mb-3">Resep 1</p>
         <div class="flex px-6 justify-between">
            <div class="flex flex-col px-4">
               ...
               <p class="font-semibold text-lg">08 februari 2023  ||  08.45</p>
            </div>
            <div href="" class="flex flex-col md:flex-row  px-4  md:mt-0">
               <a href="" class="text-red-600 text-xl font-semibold mt-2 md:my-auto ml-3">Delete</a>
            </div>
         </div>
         <hr class="h-0.5 bg-gray-600 mt-2">
         <p class="text-3xl font-extrabold px-6 mb-3">Resep 2</p>
         <div class="flex px-6 justify-between">
            <div class="flex flex-col px-4">
               <a href="" class="flex flex-row underline">
                  <img src="gambar/image.svg" alt="">
