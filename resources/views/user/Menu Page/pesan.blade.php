...
<div class="p-0 md:ml-64">
   <div class="p-0  border-gray-200 rounded-lg ">
      ...
      <p class="font-bold text-xl ml-8 xl:ml-10 text-red-600">Menu</p>
      <p class="font-bold text-3xl ml-8 xl:ml-10">Pesan</p>
      <div class="mt-4">
         <hr class="bg-gray-600 h-0.5">
         <a href="{{ url('pesan1') }}" class="flex p-4">
            <img src="gambar/Ellipse 115.png" alt="">
            <p class="font-bold text-xl ml-3 mt-2">Apoteker 1 <span class="font-normal text-lg"><br>: Ada yang bisa dibantu?</span> </p>
         </a>
         <hr class="bg-gray-600 h-0.5">
         <div class="flex p-4">
            <img src="gambar/Ellipse 115.png" alt="">
            <p class="font-bold text-xl ml-3 mt-2">Apoteker 2 <span class="font-normal text-lg"><br>: Ada yang bisa dibantu?</span> </p>
         </div>
         <hr class="bg-gray-600 h-0.5">
         <div class="flex p-4">
            <img src="gambar/Ellipse 115.png" alt="">
            <p class="font-bold text-xl ml-3 mt-2">Apoteker 3 <span class="font-normal text-lg"><br>: Ada yang bisa dibantu?</span> </p>
         </div>
         <hr class="bg-gray-600 h-0.5">
      </div>
