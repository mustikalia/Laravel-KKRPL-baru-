      ...
      <ul class="space-y-2 font-medium">
         ...
         <li class="px-3">
            <a href="{{ url('kirim') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               <img src="gambar/Documentred.svg" alt="">
               <span class="ms-3 text-red-600">Kirim Resep</span>
            </a>
         </li>
         <hr class="bg-gray-600 h-0.5">
         <li class="px-3">
   ...
   <div class="p-0  border-gray-200 rounded-lg ">
      <div class="flex justify-between mb-4 ">
         <div class="flex mt-2">
            ...
            <span class="font-bold text-xl text-red-600 ml-2">Menu <span class="text-2xl text-black"><br>Kirim Resep</span></span>
         </div>
      ...
      <div>
         <p class="font-semibold text-xl ml-24 sm:ml-32 md:ml-40 xl:ml-52 mt-6">Unggah resep anda disini</p>
         <div class="mt-2 border-2 border-red-700 border-solid rounded-lg p-5 w-[70%] flex flex-col justify-center mx-auto items-center mb-5">
            <div class="flex items-center justify-center w-full  mx-auto">
               <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-[450px] border-2 border-red-600 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100">
                  <div class="flex flex-col items-center justify-center pt-5 pb-6">
                     <button class="flex rounded-3xl p-2 px-6 border border-gray-300 shadow-xl">
                        <img src="gambar/button.svg" alt="">
                        <p class="text-red-500 text-lg ml-2 mt-1">Select a File</p>
                     </button>
                     <p class="text-gray-500 mt-5 text-lg font-medium">or</p>
                     <p class="text-black mt-4 text-xl font-normal">Drag and drop a file here</p>
                  </div>
                  <input id="dropzone-file" type="file" class="hidden" />
               </label>
            </div> 
            <button class="text-white bg-red-600 hover:bg-red-700 px-20 py-2 rounded-3xl font-semibold text-xl mt-5">Kirim</button>
            <p class="justify-center text-center font-semibold text-xl mt-5 "><span class="text-red-600">Apotik Hinda</span> Farma akan menolak dan tidak bertanggung jawab atas setiap kerugian dan risiko yang dapat timbul dari pemakaian obat tertentu yang dibeli melalui penebusan ulang resep.</p>
         </div>
         <a href="{{ url('riwayatresep') }}" class="flex justify-center mb-10 mt-5">
            <img src="gambar/Union.svg" alt="">
            <p class="font-semibold text-xl ml-2 text-red-600">Cek riwayat kirim resep</p>
         </a>
      </div>
